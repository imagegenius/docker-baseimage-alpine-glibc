pipeline {
  ...
  environment {
    ...
    DOCKERHUB_IMAGE = 'imagegenius/baseimage-alpine-glibc'
    DEV_DOCKERHUB_IMAGE = 'igdev/baseimage-alpine-glibc'
    PR_DOCKERHUB_IMAGE = 'igpipepr/baseimage-alpine-glibc'
    DIST_IMAGE = 'alpine'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'false'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker build \
          ...
          --label \"org.opencontainers.image.source=https://github.com/imagegenius/docker-baseimage-alpine-glibc\" \
